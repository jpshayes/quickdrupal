 ...
 */
function drupalpress_profile_details() {
  return array(
    'name' => 'Drupal Press',
 ...
 *   task list.
 */
function drupalpress_profile_task_list() {
}
 ...
 */
function drupalpress_profile_tasks(&$task, $url) {
 ...
 */
function drupalpress_form_alter(&$form, $form_state, $form_id) {

...
<body class="<?php print drupal_press_body_class($is_front, $logged_in, $is_admin, $node, $left, $right); ?>">
  <div id="header">
    ...
    <div class="container_16">
      ...
      <div id="main" class="<?php print $mainGridClass; ?>">
        ...
        <div id="content">
          ...
          <?php if (!empty($tabs)): ?><div class="tabs"><?php print $tabs; ?><div class="clear"></div></div><?php endif; ?>

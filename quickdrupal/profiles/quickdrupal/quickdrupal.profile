<?php
// $Id: quickdrupal.profile,v 1.0 2010/11/19 08:31:03 jpsh Exp $
 ...
 */
function quickdrupal_profile_modules() {
	...
	'help', 'menu', 'taxonomy', 'dblog', 'contact', 'blog', 'path',
  
	//Enable contributed modules
	'admin_menu', 'backup_migrate', 'poormanscron', 'vertical_tabs', 'content', 'filefield', 'imagefield', 'ckeditor', 'imageapi', 'imageapi_gd', 'imagecache', 'imagecache_ui', 'token', 'pathauto', 'views', 'views_ui', 'features',
	
	//Enable custom modules
	'quickdrupal', 'roles_permissions'
	);
 ...
 *   task list.
 */
function quickdrupal_profile_task_list() {
}
 ...
 */
function quickdrupal_profile_tasks(&$task, $url) {
